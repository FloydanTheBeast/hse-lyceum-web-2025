...
> Все задания - для базы данных chinook

1. Посчитатайте среднюю и общую длину треков для каждого жанра при помощи оконных функций
2. Создайте представление (view) `artist_revenue`, содержащее суммарную прибыль и количество продаж каждого артиста
...
Напишите простое приложение - **сокращатель ссылок**

### Критерии:
- Веб-приложение, позволяющее создать сокращение для ссылки и валидирующее ввод пользователя
- Бэкэнд, позволяющий создать сокращение и перейти на оригинальный сайт по сокращению
- Использование базы данных (sqlite или любая другая)
